...
public class Handler implements MagpieExecutor {
    ...
    public Handler() {
        ...
        hBaseOP.getConf().set("hbase.rootdir","hdfs://qhadoop8:9000/hbase");
        hBaseOP.getConf().set("hbase.cluster.distributed","true");
        hBaseOP.getConf().set("hbase.zookeeper.quorum", "qhadoop7,qhadoop8,qhadoop9");
        hBaseOP.getConf().set("hbase.zookeeper.property.clientPort","2181");
        hBaseOP.getConf().set("hbase.tmp.dir","/data0/hbase");
        hBaseOP.getConf().set("hbase.regionserver.port","60021");
        hBaseOP.getConf().set("hbase.regionserver.info.port","60031");
